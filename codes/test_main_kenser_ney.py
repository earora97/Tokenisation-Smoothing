...
from kenser_ney_lap_wb import kenser_ney_lp_wb
import numpy as np
...
k=kenser_ney_lp_wb()
k.bigram_smooth_laplace_kn()
np.save("bigram_laplace_kn.dict",k.bigram_laplace_kn)
k.trigram_smooth_laplace_kn()
np.save("trigram_laplace_kn.dict",k.trigram_laplace_kn)
k.bigram_smooth_wb_kn()
np.save("bigram_wb_kn.dict",k.bigram_wb_kn)
k.trigram_smooth_wb_kn()
np.save("trigram_wb_kn.dict",k.trigram_wb_kn)
